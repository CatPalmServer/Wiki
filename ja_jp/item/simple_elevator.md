...
<table>
    <tr>
        <td align="center">レッドストーン信号不要</td>
        <td align="center">レッドストーン信号必要</td>
    </tr>
    <tr>
        <td>
            <table>
...
## 使用方法
同じ高さに少なくとも2つのエレベーターを設置する必要があります：
...
エレベーターの上には非固形ブロックを2つ空ける必要があります。そうしないと、移動できません：

<table>
    <tr><td align="center">有効</td><td><img src="https://i.imgur.com/3fOeV1n.png" width="360"/><img src="https://i.imgur.com/b2QOaTl.png" width="360"/></td></tr>
    <tr><td align="center">無効</td><td><img src="https://i.imgur.com/JYYtFGz.png" width="360"/></td></tr>
</table>

### レッドストーン版
レッドストーン信号が必要ですが、他のエレベーターに移動することができます。
