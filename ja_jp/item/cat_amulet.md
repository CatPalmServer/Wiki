...
## データ
<table>
    <tr><td align="end">画像</td><td><img src="https://i.imgur.com/SgUm9Sf.png" width="128"/></td></tr>
...
## 使用
バックパックに入れることで[夜魅](https://minecraft.fandom.com/zh/wiki/夜魅)生成をブロックし、1ブロックごとに1ネコのお守りを消費する。