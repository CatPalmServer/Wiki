...
## ゲット
ナイトメアクリスタルマインは[竜牙鎬、血竜牙鎬、ナイトメアジェム鎬](pickaxe.md)のみで採掘でき、[シルクタッチ](https://minecraft.fandom.com/zh/wiki/シルクタッチ)を使用しなくてもナイトメアジェム碎片1個をドロップします。  
[ジ・エンド](https://minecraft.fandom.com/zh/wiki/ジ・エンド)は1チャンクあたり0.01%の確率で高度20~60のナイトメアジェム礦の生成を試み、選択された座標が[エンドストーン](https://minecraft.fandom.com/jp/wiki/エンドストーン)でない場合、その生成は破棄されます。
