...
各彩色キャンバスの解像度は128x128で、使用可能な色は[カラーパレット](palette.md)を参照してください。

### 絵を描く
[筆](pen.md)と[カラーパレット](palette.md)が必要で、彩色キャンバスを[アイテムフレーム](https://minecraft.fandom.com/zh/wiki/アイテムフレーム)に置いてください。
