[← ホームに戻る](../)
# 強化された放浪者
周囲24ブロック以内に[幸運](https://minecraft.fandom.com/ja/wiki/幸運)状態効果を持つプレイヤーがいる場合、1レベルごとにレアトレード(6.5%/2.95%/0.5%/0.05%)の確率倍率が1%上昇し、最大で10%まで増加します。  
_たとえば、4人のプレイヤーが幸運IIIを持っている場合、0.5%の確率は、0.5% x (1.0 + min(10, 3 x 4) x 0.01) = 0.55%になります。_
