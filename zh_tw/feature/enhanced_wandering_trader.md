[← 回主頁](../)
# 增強型流浪商人
附近`24`格內有[幸運](https://minecraft.fandom.com/zh/wiki/幸運)狀態效果的玩家，每`1`等都會使稀有交易 (`6.5%`/`2.95%`/`0.5%`/`0.05%`) 的機率`倍率`提高`1%`，最多提升至`10%`。  
_例如 4 位玩家身上有`幸運III`，原本`0.5%`機率被提升至`0.5%`x(`1.0`+最小值(`10`,`3`x`4`)x`0.01`) = `0.55%`_
