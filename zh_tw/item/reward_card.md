...
## 用途
首次使用右鍵開啟選單後`30`天內可累計最多`30`點，每天需要上繳`1`個指定物品來獲得`1`點、可使用[超級魚餅乾](super_fish_cracker.md)補簽：  
...
<table>
    ...
    <tr><td align="center">生怪蛋</td><td align="start">生怪磚、無法被<a href="entity_storage_rope.md">收納</a>的生怪蛋</td></tr>
