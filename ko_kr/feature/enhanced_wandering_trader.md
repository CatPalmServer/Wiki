[← 홈으로](../)
# 강화된 방랑상인
주변 24블록 내에 [행운](https://minecraft.fandom.com/ko/wiki/행운) 상태 효과가 있는 플레이어가있는 경우, 1 레벨 당 레어 거래 (6.5 % / 2.95 % / 0.5 % / 0.05 %)의 확률 배율이 1 % 증가하며, 최대 10 %까지 증가합니다.  
_예를 들어, 4 명의 플레이어가 행운 III를 가지고있는 경우, 0.5 % 확률은 0.5 % x (1.0 + min (10, 3 x 4) x 0.01) = 0.55 %가됩니다._
