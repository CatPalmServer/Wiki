...
<table>
    ...
    <tr>
        <td>
            <table>
                <tr><td align="end">이미지</td><td><img src="https://i.imgur.com/4eKYni0.png" width="128"/></td></tr>
        ...
        <td>
            <table>
                <tr><td align="end">이미지</td><td><img src="https://i.imgur.com/zWMjq19.png" width="128"/></td></tr>
                <tr><td align="end">스택</td><td>1</td></tr>
                <tr><td align="end">인챈트</td><td>없음</td></tr>
            </table>
        </td>
...
만약 전송 지점이 존재하지 않으면 소비한 아이템을 반환하고 오류 메시지를 표시합니다.
